/* ------------------------------------------------------------------ */
/*  ZURI COSMETICS — SEED DATA (shared)                                */
/*  Used by BOTH:                                                      */
/*    1. the CLI seed script  (src/db/seed.ts)                         */
/*    2. the runtime bootstrap (src/db/bootstrap.ts) which auto-seeds  */
/*       a fresh production database (e.g. a new Neon instance on      */
/*       Vercel) the first time the app runs.                          */
/* ------------------------------------------------------------------ */
...
const CATALOGUE: ProductSeed[] = [
  /* ----------------------------- LASHES ----------------------------- */
  {
    ...
    whatsIncluded: ["Cluster lashes", "Lash glue", "Lash application tongs", "Spooly"],
    specifications: {
  ...
  },
  {
    ...
    whatsIncluded: ["Strip lashes", "Lash glue", "Lash application tongs", "Spooly"],
    specifications: {
  ...
  },
  {
    ...
    specifications: {
      Use: "Prep & protection",
      Volume: "Confirmed on package",
      Dry: "Quick-dry formula",
    },
    ingredients:
      "Full ingredient listing is printed on each product package and will be published here once confirmed by our supplier.",
    price: "119.00",
  ...
  },
  {
    ...
    specifications: {
      Pieces: "6-piece prep set",
      Case: "Soft-touch travel case",
      Use: "Manicure prep & aftercare",
    },
    price: "249.00",
    stock: 15,
    sku: "ZUR-NAIL-007",
  ...
  /* ---------------------------- LIPGLOSS ----------------------------- */
  {
    ...
    specifications: {
      Finish: "High shine",
      Texture: "Cushiony, non-sticky",
      Wear: "Layer or wear alone",
    },
    ingredients:
      "Full ingredient listing is printed on each product package and will be published here once confirmed by our supplier.",
    price: "109.00",
    stock: 32,
    sku: "ZUR-LIP-001",
    images: [IMG.glossChain, IMG.glossTubes],
    tags: ["lips", "gloss"],
    soldUnits: 176,
    createdDaysAgo: 75,
  ...
  },
  {
    ...
    specifications: {
      Finish: "Mirror shine, sheer colour",
      Texture: "Cushiony, non-sticky",
      Shades: "Growing edit",
    },
    ingredients:
...
const TUTORIALS = [
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/3971913/3971913-hd_1920_1080_25fps.mp4",
    posterUrl:
      "https://images.pexels.com/videos/3971913/pexels-photo-3971913.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=630&w=1200",
    steps: [
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/7754495/7754495-hd_1920_1080_30fps.mp4",
    posterUrl:
      "https://images.pexels.com/videos/7754495/pexels-photo-7754495.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=630&w=1200",
    steps: [
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/12322768/12322768-hd_1920_1080_30fps.mp4",
    posterUrl:
      "https://images.pexels.com/videos/12322768/pexels-photo-12322768.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=630&w=1200",
    steps: [
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/10491722/10491722-hd_1920_1080_25fps.mp4",
    posterUrl:
      "https://images.pexels.com/videos/10491722/pexels-photo-10491722.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=630&w=1200",
    steps: [
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/6961746/6961746-uhd_3840_2160_25fps.mp4",
    posterUrl:
      "https://images.pexels.com/videos/6961746/pexels-photo-6961746.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=630&w=1200",
    steps: [
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/7820126/7820126-hd_1920_1080_25fps.mp4",
    posterUrl:
      "https://images.pexels.com/videos/7820126/adult-arts-and-crafts-bathroom-beauty-7820126.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=630&w=1200",
    steps: [
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/3997856/3997856-uhd_4096_2160_25fps.mp4",
    posterUrl:
      "https://images.pexels.com/videos/3997856/pexels-photo-3997856.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=630&w=1200",
    steps: [
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/7754856/7754856-hd_1920_1080_30fps.mp4",
    posterUrl:
      "https://images.pexels.com/videos/7754856/adult-applying-beauty-beauty-salon-posters-7754856.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=630&w=1200",
    steps: [
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/7754857/7754857-hd_1920_1080_30fps.mp4",
    posterUrl:
      "https://images.pexels.com/videos/7754857/beauty-beauty-salon-posters-cosmetics-facial-7754857.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=630&w=1200",
    steps: [
  ...
  },
  {
    ...
    videoUrl:
      "https://videos.pexels.com/video-files/4783391/4783391-uhd_3840_2160_30fps.mp4",
    posterUrl:
      "https://images.pexels.com/videos/4783391/active-lifestyle-adult-adults-only-beautician-4783391.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=630&w=1200",
    steps: [
...
const FAQS = [
  ...
  },
  {
    ...
    answer: `Our current delivery estimate is ${
      process.env.NEXT_PUBLIC_DELIVERY_ESTIMATE ||
      "2 – 5 working days across South Africa"
    }. You will receive an order confirmation with your order number as soon as your order is placed, and tracking details once your parcel ships.`,
    category: "delivery",
    sortOrder: 6,
  },
  {
